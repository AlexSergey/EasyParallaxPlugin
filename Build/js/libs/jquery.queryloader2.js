...
OverlayLoader.prototype.createOverlay = function () {
	...
	this.loadbar = $('<div class="preloader_view"><div class="loader_4"><div>G</div><div>N</div><div>I</div><div>D</div><div>A</div><div>O</div><div>L</div></div></div>').appendTo(this.container);
